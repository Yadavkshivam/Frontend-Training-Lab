...
import { MODULE_REGISTRY } from "./PracticePage";
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mt-10">
        <div className="flex items-center justify-between mb-5">
          <div>
            <h2 className="text-lg font-semibold text-slate-800">Practice Modules</h2>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-indigo-600
                       bg-indigo-50 hover:bg-indigo-100 rounded-xl transition-colors cursor-pointer"
          >
